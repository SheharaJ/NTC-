...
router.get('/view-schedules', operatorProtect, getSchedulesForOperator);

// Route to view seat bookings for operator's buses
router.get('/view-seat-bookings', operatorProtect, getSeatBookingsForOperator);
...
/**
 * @swagger
 * /ntc/bus-operators/action/view-schedules:
 *   get:
...
/**
 * @swagger 
 * /ntc/bus-operators/action/view-seat-bookings:
 *   get:
...
/**
 * @swagger
 * /ntc/bus-operators/action/reassign-bus:
 *   put:
