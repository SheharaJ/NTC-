...
router.post('/createBusOperator', protect, verifyAdminRole, addBusOperator);
...
/**
 * @swagger
 * /ntc/admin/busOperators/createBusOperator:
 *   post:
...
/**
 * @swagger
 * /ntc/admin/busOperators/{operatorId}:
 *   get:
