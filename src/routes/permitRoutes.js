...
router.get('/view', protect, verifyAdminRole, getPermits);
router.delete('/deactivate/:id', protect, verifyAdminRole, deactivatePermit);
router.get('/view/:id', protect, verifyAdminRole, getPermitById);
...
/**
 * @swagger
 * /ntc/admin/permits/deactivate/{id}:
 *   delete:
